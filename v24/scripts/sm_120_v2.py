...
top3_buy_cost = 3 * TRADE_COST
top3_net = top3_raw - top3_buy_cost
top3_full_cycle = top3_raw - top3_buy_cost - 3 * TRADE_COST
...
print("\\nTop1: " + CODES[top10_idx[0]] + " raw=" + str(round(top1_raw*100,3)) + "%% net(entry)=" + str(round((top1_raw-TRADE_COST)*100,3)) + "%%")
