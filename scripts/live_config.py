...
PROFILES = {
    ...
    "aggr2w": {
        ...
        "skip-boards": "30,688",
        "desc": "只持 2 只, 预算大高价股也能买。仅主板: 回测近3年 +94% (主板集成, 前半段曾跑输主板基准)。",
    },
    "steady5w": {
        "name": "稳妥 5万",
        "capital": 50000.0,
        ...
        "desc": "5 只分散, 单股爆雷影响最小。仅主板: 回测近3年 +84%, 两段都跑赢主板基准。",
    },
    "aggr5w": {
        "name": "激进 5万",
        "capital": 50000.0,
        "tranche-n": 3,
        "skip-boards": "30,688",   # 同 aggr2w: 账户无创/科板权限
        "desc": "仅 3 只集中。仅主板: 回测近3年 +108% / 回撤 -29%, 两段都跑赢主板基准。",
    },
    "aggr10w": {
        "name": "激进 10万",
        "capital": 100000.0,
        "tranche-n": 3,
        "skip-boards": "30,688",   # 同 aggr2w: 账户无创/科板权限
        "desc": "仅 3 只集中, 10万本金。仅主板: 回测近3年 +118% / 回撤 -37%, 两段都跑赢主板基准。",
    },
    # ── 不可更改的基准线 ───────────────────────────
    ...
    "base5w_steady": {
        ...
        "desc": "全市场版的 5 只持仓参照组(含创业板/科创板, 与「稳妥 5万」的"
                "仅主板不同)。永久纸面自动记账, 不可改名/不可改记账方式/"
                "不可校准现金/不可删持仓。用途: 对比开通创/科板权限的影响。",
    },
    "base5w_aggr": {
        "name": "基准·激进5万",
        "capital": 50000.0,
