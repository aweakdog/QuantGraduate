...
PROFILES = {
    "steady2w": {
        ...
        "tranche-n": 3,
        "lot-flex": 0.5,
        "desc": "2万本金下可行的最分散方案。回测 IR 0.86 (新数据口径, flex0.5), 两段都跑赢。",
    },
    "aggr2w": {
        "name": "激进 2万",
        "capital": 20000.0,
        "tranche-n": 2,
        "lot-flex": 0.5,
        "desc": "只持 2 只, 预算大高价股也能买。回测 IR 0.70 (新数据口径, flex0.5), 集中度最高。",
    },
    "steady5w": {
        "name": "稳妥 5万",
        "capital": 50000.0,
        "tranche-n": 5,
        "desc": "5 只分散, 单股爆雷影响最小。回测 IR 1.09 (新数据口径), 四线中最抗噪。",
    },
    "aggr5w": {
        "name": "激进 5万",
        "capital": 50000.0,
        "tranche-n": 3,
        "desc": "回测 IR 0.80 (新数据口径)。仅 3 只, 前3名选股方差大, 实际路径波动高。",
    },
    # ── 不可更改的基准线 ───────────────────────────
