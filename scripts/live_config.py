...
FEATURES_FROM = "wf_daily_V24B_s42_ts2022-09-01_te2026-07-27_cap100000.json"
...
PROFILES = {
    ...
    "steady5w": {
        ...
        "desc": "5 只分散(单股爆雷影响最小) · 仅主板 · 大盘弱势自动空仓。回测(20种子中位, 非单次跑): "
                "2022-09~2026-07 +58%(最差种子 +23%, 20个种子无一亏损); "
                "2020-07~2022-08 -26%(20/20 全亏)。回撤中位 -32%/-38%。约44%交易日空仓。",
    },
    "aggr5w": {
        "name": "激进 5万",
        "capital": 50000.0,
    ...
    "aggr10w": {
        ...
        "tranche-n": 3,
        "skip-boards": "30,688",   # 同 aggr2w: 账户无创/科板权限
        "desc": "仅 3 只集中, 10万本金 · 仅主板 · 大盘弱势自动空仓。回测(20种子中位, 非单次跑): "
                "2022-09~2026-07 +54%(最差种子 -8%, 1/20 亏损); "
                "2020-07~2022-08 -37%(20/20 全亏)。回撤中位 -36%/-47%。约44%交易日空仓。",
    },
    # ── 不可更改的基准线 ───────────────────────────
